/**
 * Pure matching helpers for mapping a generated answer onto the concrete options
 * of a choice field (checkbox group / radio).
 *
 * MIGRATED from workers/apply-arm/src/field-match.ts unchanged.
 */
 ...
 * match first; then containment either way so minor wording drift ("U.S.
 * citizen" vs "US citizen") still ticks the right box. Guards against the
 * classic false positive where "No" would substring-match "None ...": a
