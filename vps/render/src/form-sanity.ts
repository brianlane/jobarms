 ...
 *
 * The Databricks incident: the arm extracted a newsletter box (1 email field)
 * and confidently proceeded. A real application virtually always has an
 * email + name pair, a resume upload, or substantial question volume.
 *
 * MIGRATED from workers/apply-arm/src/form-sanity.ts unchanged.
 */
